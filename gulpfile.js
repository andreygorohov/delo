...
exports.default = series(clean, parallel(htmlInclude, scripts, fonts, styles, images, svgSprites), browsersync);
...
exports.build = series(clean, parallel(htmlInclude, scriptsBuild, fonts, images, svgSprites), stylesBuild);
